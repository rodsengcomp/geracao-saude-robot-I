        ...
        "aoColumnDefs": [
            ...
            },
            {
                ...
                "mRender": function (data, type, full) { //aqui é uma funçãozinha para pegar os ids
                    return '<a href="menu.php?pag=edit-cidade&id=' + full[0] + '" role="button" class="btn btn-outline-warning rounded-circle"><i class="fa fa-pencil"></i></a>';
                }
            },
            {
    ...
    $('#list-cnes').DataTable({
        ...
        "aoColumnDefs": [
            ...
            },
            {
                "aTargets": [1], // o numero 6 é o nº da coluna
                "mRender": function (data, type, full) { //aqui é uma funçãozinha para pegar os ids
                    return '<a href="menu.php?pag=edit-cnes&id=' + full[0] + '" role="button" class="btn btn-dark rounded-circle"><span class="glyphicon glyphicon-pencil"></a>';
                }
            }
        ],
    ...
    $('#list-agravo').DataTable({
        ...
        "aoColumnDefs": [
            ...
            },
            {
                "aTargets": [1], // o numero 6 é o nº da coluna
                "mRender": function (data, type, full) { //aqui é uma funçãozinha para pegar os ids
                    return '<a href="menu.php?pag=edit-agravo&id=' + full[0] + '" role="button" class="btn btn-dark rounded-circle"><span class="glyphicon glyphicon-pencil"></a>';
                }
            }
        ],
    ...
    $('#list-end').DataTable({
        ...
        "aoColumnDefs": [
            ...
            },
            {
                "aTargets": [1], // o numero 6 é o nº da coluna
                "mRender": function (data, type, full) { //aqui é uma funçãozinha para pegar os ids
                    return '<a href="menu.php?pag=edit-end&id=' + full[0] + '" role="button" class="btn btn-dark rounded-circle"><span class="glyphicon glyphicon-pencil"></a>';
                }
            },
            {
